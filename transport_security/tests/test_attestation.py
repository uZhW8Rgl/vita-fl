...
def fixture(monkeypatch):
    ...
    return SimpleNamespace(der=der, pem=pem, claims=claims, quote=quote, evidence=evidence, opener=opener)
...
def test_session_binds_exact_peer_key_challenge_sello_and_quote(fixture):
    ...
    call = fixture.opener.open.call_args
    assert call.args[0].full_url == a.DEFAULT_PHALA_VERIFY_URL
    assert json.loads(call.args[0].data) == {"hex": fixture.quote.hex()}
