...
append_var_if_set "os_image" "PHALA_OS_IMAGE"
append_var_if_set "contracts_os_image" "PHALA_CONTRACTS_OS_IMAGE"
append_var_if_set "dynamic_worker_os_image" "PHALA_DYNAMIC_WORKER_OS_IMAGE"
append_var_if_set "dynamic_worker_node_id" "PHALA_DYNAMIC_WORKER_NODE_ID"
append_var_if_set "contracts_replicas" "PHALA_CONTRACTS_REPLICAS"
append_var_if_set "contracts_wait_for_ready" "PHALA_CONTRACTS_WAIT_FOR_READY"
