...
append_var_if_set "bootstrap_min_recipients" "BOOTSTRAP_MIN_RECIPIENTS"
append_var_if_set "bootstrap_registration_settle_seconds" "BOOTSTRAP_REGISTRATION_SETTLE_SECONDS"
append_var_if_set "bootstrap_registration_timeout_seconds" "BOOTSTRAP_REGISTRATION_TIMEOUT_SECONDS"
append_var_if_set "bootstrap_registration_poll_seconds" "BOOTSTRAP_REGISTRATION_POLL_SECONDS"
