export const parseDecimalRate = (value, name) => {
...
export const formatDecimalUnits = (value, decimals) => {
    if (value < 0n) {
...
export const valueWeiAtRate = (valueWei, rate) => formatDecimalUnits(valueWei * rate.coefficient, 18 + rate.scale);
export const gweiRateToWei = (rate) => {
    if (rate.scale > 9) {
...
export const transactionCostAmounts = (gasUsed, effectiveGasPriceWei, ethEurRate, ethUsdRate) => {
