...
export const deriveRoundAggregationPolicyHash = ({ configurationVersion, requiredSubmissions, openedAt, deadline, algorithmHash, validationDataHash, maxLossIncreaseBps, }) => hashEncoded([
    "bytes32",
    "uint64",
    "uint32",
    "uint64",
